...
Documento de especificação visual, arquitetura de UI/UX e tokens de design do sistema **Game Library Organize** (Organizador de Bibliotecas Digitais de Jogos). Otimizado para interpretação direta e prática por agentes de IA e desenvolvedores Laravel \+ Livewire.
...
Para garantir a troca dinâmica de cores e Light/Dark Mode no Livewire \+ CSS, utilize as seguintes variáveis raiz:
