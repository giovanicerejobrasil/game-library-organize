    ...
    <section class="relative overflow-hidden py-16 lg:py-24 border-b border-[var(--border-color)]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                <a href="{{ auth()->check() ? route('dashboard') : route('register') }}" class="px-6 py-3 text-base font-semibold rounded-[var(--radius-md)] bg-[var(--bg-card)] border border-[var(--border-color)] text-[var(--text-main)] hover:border-[var(--brand-primary)] hover:shadow-[var(--glow-retro)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
                    Adicionar Jogos
                </a>
            </div>
