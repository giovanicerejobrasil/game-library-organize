...
description: >
  ...
  Rejeita soluções superficiais, impõe boas práticas na stack Laravel, Vue.js, Elasticsearch, PostgreSQL e Docker, e garante alta qualidade de software.
license: MIT 
metadata: 
...
* **Camada de Reatividade (Vue.js):** Reutilização de componentes, isolamento de estado com Pinia/Vuex e consumo correto das variáveis CSS de tema.  
...
* **Modelagem de Dados**:  
  ...
  * user\_game: Tabela pivô contendo o progresso e avaliação do usuário (status: finalizado/jogando/desistido, horas jogadas, nota 0-5, review escrita).  
...
### **3. Frontend (Vue.js \+ CSS Variables)**

* Componentização coesa: GameCard.vue, GameGrid.vue, GameFilter.vue, StarRating.vue, ReportChart.vue.  
